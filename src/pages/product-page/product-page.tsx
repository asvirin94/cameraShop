...
export default function ProductPage() {
  ...
  const propertyTabClassname = tab === 'properties'
    ? 'tabs__element is-active'
    : 'tabs__element';
  const descriptionTabClassname = tab === 'description'
    ? 'tabs__element is-active'
    : 'tabs__element';
                    ...
                    <div className="product__content">
                      ...
                      <div className="tabs product__tabs">
                        <div className="tabs__controls product__tabs-controls">
                          <button
                            className={`tabs__control ${tab === 'properties' ? 'is-active' : ''}`}
                            type="button"
                            onClick={() => {
                              if(tab === 'description') {
                          ...
                          <button
                            className={`tabs__control ${tab === 'description' ? 'is-active' : ''}`}
                            type="button"
                            onClick={() => {
                              if(tab === 'properties') {
                      ...
                      <li className="review-card">
                        ...
                        <ul className="review-card__list">
                          ...
                          <li className="item-list">
                            <span className="item-list__title">Комментарий:</span>
                            <p className="item-list__text">
                            При попытке вставить плёнку сломался механизм
                            открытия отсека, пришлось заклеить его изолентой.
                            Начал настраивать фокус&nbsp;— линза провалилась
                            внутрь корпуса. Пока доставал — отломилось несколько
                            лепестков диафрагмы. От злости стукнул камеру об
                            стол, и рукоятка треснула пополам. Склеил всё
                            суперклеем, теперь прижимаю ей бумагу. НЕ
                            РЕКОМЕНДУЮ!!!
                            </p>
                          </li>
                        </ul>
                      ...
                      <li className="review-card">
                        ...
                        <ul className="review-card__list">
                          ...
                          <li className="item-list">
                            ...
                            коллекции как раз не хватало такого экземпляра.
                            Следов использования нет, доставили в заводской
                            упаковке, выглядит шикарно!
                            </p>
                          </li>
                        </ul>
                      </li>
